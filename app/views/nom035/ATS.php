...
<div class="card">
	...
	<div class="card-body">
		<p>
			<strong>
				¿Ha presenciado o sufrido alguna vez, durante o con motivo del trabajo un acontecimiento como los
				siguientes?
			</strong>
		</p>
			...
			<table class="table table-hover">
				<tbody>
					...
					<tr>
						...
						<td>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="ATS_ASALTO" id="ATS_ASALTO" value="1"
									required>
								<label class="form-check-label" for="ATS_ASALTO">Sí</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="ATS_ASALTO" id="ATS_ASALTO" value="2"
									required checked>
